...
<html>
    ...
    <body>
        ...
        <div class="position-absolute top-50 start-50 translate-middle w-75 p-3" style="">
            ...
            <form class="row g-3" action="createAccount" enctype="multipart/form-data" method="POST">
                <div class="col-md-6">
                    Username
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" name="txtPhotoCode" class="form-control"  value="" />
                </div>
                <div class="col-12">
                    Password
                ...
                <div class="col-md-2">
                    ...
                    <select name="txtStatus" class="form-select" id="inlineFormSelectPref">
                ...
                <div class="col-12">    
                    <button type="submit" class="btn btn-warning form-control" >Create Account</button> <br/>
