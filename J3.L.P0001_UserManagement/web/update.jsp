...
<html>
    ...
    <body>
        ...
        <div class="position-absolute top-50 start-50 translate-middle w-75 p-3" style="">
            <form class="row g-3" action="update" enctype="multipart/form-data" method="POST">
...
<!--                    <a href="https://imgbb.com/"><img src="${sessionScope.USER_INFO.getPhotoCode()}" alt="download" border="0" style=“width:128px;height:128px;"></a>
                    ...
                    <img src="image/${sessionScope.USER_INFO.getPhotoCode()}" width="128px" height="128px" alt=""/>
                    <input type="file" name="txtPhotoCode" class="form-control"  value="${sessionScope.USER_INFO.getPhotoCode()}" />
                </div>
