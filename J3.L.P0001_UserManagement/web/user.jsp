    ...
    <body>
        ...
        <div class="position-absolute top-50 start-50 translate-middle w-75 p-3" style="">
            <form class="row g-3">
                <div class="col-md-6">
                    Username
                    <input type="text" class="form-control" value="${sessionScope.USER.getUsername()}" disabled="">
                </div>
                <div class="col-md-6">
                    Photo
                    <!--<a href="https://imgbb.com/"><img src="${sessionScope.USER.getPhotoCode()}" alt="download" border="0" style=“width:128px;height:128px;"></a>-->
                    <div>
                        <img src="image/${sessionScope.USER.getPhotoCode()}"  border="0" style=“width:128px;height:128px;">
                    </div>

                </div>
                <div class="col-12">
                    Password
                    <input type="text" class="form-control" value="${sessionScope.USER.getPassword()}" disabled="">
                </div>

                <div class="col-12">
                    Name
                    <input type="text" class="form-control" id="" value="${sessionScope.USER.getName()}" disabled="">
                </div>
                <div class="col-md-6">
                    <label for="inputEmail14" class="form-label">Email</label>
                    <input type="Email" class="form-control" id="inputEmail4" value="${sessionScope.USER.getEmail()}" disabled="">
                </div>
                <div class="col-md-4">

                    <label for="inputPhone" class="form-label">Phone Number</label>
                    <input type="text" class="form-control" id="" value="${sessionScope.USER.getPhoneNumber()}" disabled="">
                ...
                <div class="col-md-2">
                    ...
                    <c:if test="${sessionScope.USER.getRole() ne '1'}">
                        <input type="text" class="form-control" id="" value="User" disabled="">
                    </c:if>
                </div>
<!--                <div class="col-md-2">
