...
public class userDAO implements Serializable {
    ...
    public List<userDTO> getListUser() throws SQLException, NamingException {
        ...
        try {
            ...
            if (cn != null) {
                String sql = "Select Username, Password, PhotoCode, Name, Email, PhoneNumber, Role, Status\n"
                        + "from tblUser where Status = 'Active'";
                pst = cn.prepareStatement(sql);
                rs = pst.executeQuery();
                while (rs.next()) {
                    String username = rs.getString("Username");
    ...
    public List<userDTO> getListUserByRole(String Role) throws SQLException, NamingException {
        ...
        try {
            ...
            if (cn != null) {
                String sql = "SELECT Username, Password, PhotoCode, Name, Email, PhoneNumber, Role, Status\n"
                        + "FROM tblUser \n"
                        + "WHERE Role like ? and Status = 'Active'";
                pst = cn.prepareStatement(sql);
    ...
    public List<userDTO> getListUserActive() throws SQLException, NamingException {
        List<userDTO> listUser = new ArrayList<>();
        Connection cn = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
    ...
    public List<userDTO> getListUserByRoleActive(String Role) throws SQLException, NamingException {
        List<userDTO> listUser = new ArrayList<>();
        Connection cn = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
    ...
    public List<userDTO> getListUserByNameActive(String Username) throws SQLException, NamingException {
        List<userDTO> listUser = new ArrayList<>();
        Connection cn = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
